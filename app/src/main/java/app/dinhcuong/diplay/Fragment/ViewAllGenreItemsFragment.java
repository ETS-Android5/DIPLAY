...
public class ViewAllGenreItemsFragment extends Fragment {
    View view;
    ...
    String id_genre, name_genre, image_genre;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (bundle != null) {
            id_genre = bundle.getString("id_genre");
            name_genre = bundle.getString("name_genre");
            image_genre = bundle.getString("image_genre");
        }
    ...
    private void init() {
        ...
        collapsingToolbarLayout.setTitle(getResources().getString(R.string.GENRES) + " | " + name_genre);
        collapsingToolbarLayout.setExpandedTitleTextAppearance(R.style.ExpandedAppBarBig);
        collapsingToolbarLayout.setCollapsedTitleTextAppearance(R.style.CollapsedAppBar);

        Picasso.get().load(image_genre).transform(new BlurTransformation(getContext(), 10, 1)).into(imageBackground);
    }
    ...
    private void getData(String id_genre) {


        DataService dataService = APIService.getService();

        Call<List<Album>> callbackAlbum = dataService.handlerGetDataAlbumsOfGenre(id_genre, "album");
        ...
        Call<List<Playlist>> callbackPlaylist = dataService.handlerGetDataPlaylistsOfGenre(id_genre, "playlist");
